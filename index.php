    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
          <a class="navbar-brand" href="#">
            <img src="assets1\images\collagelogo.jpg" alt="" height="30" class="d-inline-block align-top">
            Computer Department
        </a>
            <div>
      ...
      <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="assets1/images/college.jpeg" class="d-block w-100" alt="...">
      ...
      <div class="container mt-2">
        ...
        <div class="welcome mb-2 text-center">
            <h2>About Us</h2>
            <p></p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 text-center">
                          <div class="welcome mb-2">
                            ...
                            <!-- Your content for the right container goes here -->
                        </div>
                    </div>
                </div>
                </span>
    ...
    <div id="carouselExampleSlidesOnly" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
              ...
              <div class="text-in-image">
                <div class="corousel-caption">
                  ...
                  <marquee style="height:350px;" direction="up" onmouseover="this.stop();" onmouseout="this.start();">
                    <a href="#" target="_blank" style="color:#fff">Notice 1</a>
                    <hr>
                    <br>
                    <a href="#" target="_blank" style="color:#fff">Notice 2</a>
                    <hr>
                    <br>
                  </marquee>
                </div>
          ...
          <img src="assets1/images/notice1.jpg" class="d-block w-100 h-50" alt="...">
        </div>
      </div>
    </div>
